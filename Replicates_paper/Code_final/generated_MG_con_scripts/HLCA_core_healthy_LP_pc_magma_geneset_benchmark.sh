...
for dir_name in "${metrics_dirs[@]}"; do
  ...
  mkdir -p /scratch/user/uqali4/geneset_res/Con_MG_set/HLCA_core_healthy_LP_pc/${dir_name}
  new_res_dir="/scratch/user/uqali4/geneset_res/Con_MG_set/HLCA_core_healthy_LP_pc/${dir_name}"
