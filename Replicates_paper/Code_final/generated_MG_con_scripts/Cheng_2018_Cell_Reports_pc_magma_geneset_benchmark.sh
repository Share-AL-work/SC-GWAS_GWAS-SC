...
for dir_name in "${metrics_dirs[@]}"; do
  ...
  mkdir -p /scratch/user/uqali4/geneset_res/Con_MG_set/Cheng_2018_Cell_Reports_pc/${dir_name}
  new_res_dir="/scratch/user/uqali4/geneset_res/Con_MG_set/Cheng_2018_Cell_Reports_pc/${dir_name}"
