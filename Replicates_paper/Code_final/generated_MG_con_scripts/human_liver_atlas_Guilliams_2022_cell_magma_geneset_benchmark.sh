...
for dir_name in "${metrics_dirs[@]}"; do
  ...
  mkdir -p /scratch/user/uqali4/geneset_res/Con_MG_set/human_liver_atlas_Guilliams_2022_cell/${dir_name}
  new_res_dir="/scratch/user/uqali4/geneset_res/Con_MG_set/human_liver_atlas_Guilliams_2022_cell/${dir_name}"
