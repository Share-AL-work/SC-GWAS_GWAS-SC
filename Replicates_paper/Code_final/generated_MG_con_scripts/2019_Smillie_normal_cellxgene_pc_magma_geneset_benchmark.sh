...
for dir_name in "${metrics_dirs[@]}"; do
  ...
  mkdir -p /scratch/user/uqali4/geneset_res/Con_MG_set/2019_Smillie_normal_cellxgene_pc/${dir_name}
  new_res_dir="/scratch/user/uqali4/geneset_res/Con_MG_set/2019_Smillie_normal_cellxgene_pc/${dir_name}"
