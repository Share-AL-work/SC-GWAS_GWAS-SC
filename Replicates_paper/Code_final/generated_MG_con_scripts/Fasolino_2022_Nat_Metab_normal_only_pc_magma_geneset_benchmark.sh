...
for dir_name in "${metrics_dirs[@]}"; do
  ...
  mkdir -p /scratch/user/uqali4/geneset_res/Con_MG_set/Fasolino_2022_Nat_Metab_normal_only_pc/${dir_name}
  new_res_dir="/scratch/user/uqali4/geneset_res/Con_MG_set/Fasolino_2022_Nat_Metab_normal_only_pc/${dir_name}"
