...
#SBATCH --job-name=Fasolino_2022_Nat_Metab_normal_only_pc_magma_geneset_benchmark_100kb
...
for dir_name in "${metrics_dirs[@]}"; do
  COVAR_FILE="/scratch/project/genetic_data_analysis/uqali4/MG_set_conAnnot/Fasolino_2022_Nat_Metab_normal_only_pc.${dir_name}.csv"
  mkdir -p /scratch/user/uqali4/geneset_res/Con_MG_set_oneside/Fasolino_2022_Nat_Metab_normal_only_pc/${dir_name}
  new_res_dir="/scratch/user/uqali4/geneset_res/Con_MG_set_oneside/Fasolino_2022_Nat_Metab_normal_only_pc/${dir_name}"
