...
#SBATCH --job-name=HLCA_core_healthy_LP_pc_magma_geneset_benchmark_100kb
...
for dir_name in "${metrics_dirs[@]}"; do
  COVAR_FILE="/scratch/project/genetic_data_analysis/uqali4/MG_set_conAnnot/HLCA_core_healthy_LP_pc.${dir_name}.csv"
  mkdir -p /scratch/user/uqali4/geneset_res/Con_MG_set_oneside/HLCA_core_healthy_LP_pc/${dir_name}
  new_res_dir="/scratch/user/uqali4/geneset_res/Con_MG_set_oneside/HLCA_core_healthy_LP_pc/${dir_name}"
